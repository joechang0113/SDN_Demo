...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        bands1 = [parser.OFPMeterBandDrop(int(550))]
...
#    if 400 <= pktport2-(self.pre_rx_bytes2) and pktport2-(self.pre_rx_bytes2) <= 500:
#    self.rx_rate2_fix = pktport2-(self.pre_rx_bytes2) + 200
# elif 400 > pktport2-(self.pre_rx_bytes2):
#    self.rx_rate2_fix = pktport2-(self.pre_rx_bytes2) + 300
...
# if self.flag == True:
#    if pktport12tx-(self.pre_tx_bytes12) < 400:
#       self.rx_rate12_fix = pktport12tx-(self.pre_tx_bytes12) + 193
            if stat.port_no == 7:
...
# if 400 <= pktport2-(self.pre_rx_bytes2) and pktport2-(self.pre_rx_bytes2) <= 500:
# self.rx_rate2_fix = pktport2-(self.pre_rx_bytes2) + 230
# elif 400 < pktport2-(self.pre_rx_bytes2):
# self.rx_rate2_fix = pktport2-(self.pre_rx_bytes2) + 300
        ...
        # if self.rx_rate12_fix < 1:
        #   self.rx_rate_p = (self.rx_rate12_fix)/1050
        # else
        # self.rx_rate_p = (self.rx_rate12_fix - random.randint(5,39))/1050

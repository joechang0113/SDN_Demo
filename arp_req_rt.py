...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def	arp_request_flow(self, datapath, src_ip, buffer_id=None):
	...
	match.set_arp_spa(ipv4_text_to_int(src_ip.encode('utf8')))
	...
	if pkt_arp:
	    ...
	    self.arp_request_flow(datapath, pkt_arp.src_ip)
